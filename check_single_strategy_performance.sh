    echo check_single_strategy_performance - Malawi dataset
    ...
    echo check_single_strategy_performance - Nigeria dataset
    ...
    python main.py --data real-t --semi_supervised 0 --sampling DATE --mode scratch --train_from 20130101 --test_from 20130201 --test_length 7 --valid_length 7 --initial_inspection_rate 100 --final_inspection_rate 5 --epoch 5 --closs bce --rloss full --save 0 --numweeks 300 --inspection_plan direct_decay
    
    python main.py --data real-t --semi_supervised 0 --sampling DATE --mode scratch --train_from 20130101 --test_from 20130201 --test_length 7 --valid_length 7 --initial_inspection_rate 100 --final_inspection_rate 4.5 --epoch 5 --closs bce --rloss full --save 0 --numweeks 300 --inspection_plan direct_decay