...
class POTSampling(HybridSampling):
    ...
    def __init__(self, args):
        ...
        self.coef = 0.00709741           # SD: How to decide this value?

        # self.data already exists - In main.py, we declared: sampler.set_data(data)
        
        # TO BE REMOVED
        # Kien used this pretrained embeddings  
        # # self.data = data[(data['sgd.date'] >= '16-07-01') & (data['sgd.date'] < '18-06-01')]    # Period for embedding file: './data/emb_0_3.pickle'
    ...
    def generate_DATE_embeddings(self):
        ...
        test_embeddings = torch.stack(date_sampler.get_embedding())         # Embeddings for test data
